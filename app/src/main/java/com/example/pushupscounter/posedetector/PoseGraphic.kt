package com.example.pushupscounter.posedetector
...
import com.example.pushupscounter.GraphicOverlay
import com.example.pushupscounter.utils.getRepCount
...
internal constructor(
    ...
    init {
        ...
        classificationTextPaint.textSize = CUSTOMIZED_POSE_CLASSIFICATION_TEXT_SIZE//POSE_CLASSIFICATION_TEXT_SIZE

        classificationTextPaint.setShadowLayer(100.0f, 0f, 0f, Color.BLACK)
    ...
    override fun draw(canvas: Canvas) {
        ...
        for (i in poseClassification.indices) {
            ...
            canvas.drawText(
                getRepCount(poseClassification[i]),
                435f, //classificationX,
                classificationY,
                classificationTextPaint
            )
            //Log.d(TAG, "draw: draw text check ->${poseClassification[i]} ->$classificationX ->$classificationY ->$classificationTextPaint")
        }
...
//        )
    ...
    companion object {
        ...
        private val CUSTOMIZED_POSE_CLASSIFICATION_TEXT_SIZE = 250.0f
    }
}